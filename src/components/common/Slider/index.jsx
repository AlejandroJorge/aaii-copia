...
import styles from '../../pages/HomePage/SlideshowSection/index.module.scss';
const Slider = ({
  slides,
  clearPlaceholders,
  onVariantPick,
    ...
    <>
      ...
      >
        ...
        {slides.map((slide) => (
          ...
          > 
            {slide.url && <div className={styles.content_wrapper}>  
              <Button className={styles.button} to={slide.url}>
                REVISA LAS BASES!
              </Button>    
          </div>}
            <MediaContainer
